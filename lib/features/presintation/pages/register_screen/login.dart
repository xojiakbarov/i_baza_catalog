...
import 'package:i_baza_catalog/features/presintation/pages/register_screen/reset.dart'; // Ensure you have flutter_svg package in your pubspec.yaml

class Login extends StatefulWidget {
  const Login({super.key});

  @override
  State<Login> createState() => _RagScreenState();
}

class _RagScreenState extends State<Login> {
