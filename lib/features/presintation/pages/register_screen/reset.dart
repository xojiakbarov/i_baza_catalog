...
import 'package:i_baza_catalog/features/presintation/pages/login_screen/login_screen.dart'; // Ensure you have flutter_svg package in your pubspec.yaml
import 'package:i_baza_catalog/features/presintation/pages/register_screen/signup.dart';
import 'package:i_baza_catalog/features/presintation/pages/register_screen/login.dart';
...
class Reset extends StatefulWidget {
  ...
  @override
  State<Reset> createState() => _RagScreen2State();
}

class _RagScreen2State extends State<Reset> {
